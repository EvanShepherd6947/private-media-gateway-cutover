...
> Design notes for **private-media-gateway-cutover** — a runnable python example that Privacy-gated media processing through an OpenAI-compatible Infrai endpoint.
...
- **Feature code** — the actual task: private-media-cutover.
